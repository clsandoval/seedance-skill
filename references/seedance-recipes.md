...
Load `references/genre-guides.md` for genre patterns, `references/examples-by-mode.md` when the user needs copy-ready examples, `references/shot-list-continuity.md` for professional multi-shot sequences or commercials, and `references/multilingual-community-examples.md` when the recipe should reflect Chinese/Russian/Japanese/Korean/Spanish community-style structures.
