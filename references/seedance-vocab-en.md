...
Load `references/vocab/en.md` for the full function-organized vocabulary, slop traps, and filter-trip repairs. Load `references/anti-slop-lexicon.md` for the core replacement rule and `references/filter-vocab.md` for the full false-positive repair table.
