...
> **This install executes on Replicate.** For auth, schema, upload, polling, retry, and post-processing, use `references/replicate-api.md` (main `bytedance/seedance-2.0`, never `-fast`). The notes below are background for other surfaces.
