...
Load `references/audio-guide.md` for detailed constraints, beat-sync, desync repair, audio-reference conflicts, and multi-character workarounds. Load `references/audio-post-delivery.md` when the user needs stems, M&E, dubbing, loudness, sync, mix, or delivery guidance.
