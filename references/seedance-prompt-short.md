...
For bilingual or mixed-language compression, load `references/multilingual-community-examples.md`. Keep only the language mix that clarifies reference roles, dialogue, camera terms, or safe production constraints.
