...
Load `references/reference-workflow.md` for video-motion references, `references/shot-list-continuity.md` for action handoffs across shots, and `references/examples-by-mode.md` for safe edit, extend, and R2V patterns.
